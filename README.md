...
![1](Docs/primera-haro.png)

2.- Segunda evidencia - Instalación de tailwind:
![2](Docs/segunda-haro.png)

3.- Tercera evidencia - Shadcn y su botón:
![3](Docs/tercera-haro.png)

4.- Cuarta evidencia - Layout con footer, navbar y appshell:
![4](Docs/cuarta-haro.png)

### Integrante: Oscar OlanO Paniora
1.-Primera evidencia - Proyecto corriendo:
![alt text](<Docs/creacion -evidencia 1 -oscar olano.jpg>)

2.- Segunda evidencia - Instalación de tailwind:
![alt text](<Docs/evidencia 2-oscar olano.jpg>)

3.- Tercera evidencia - Shadcn y su botón:
![alt text](<Docs/evidencia 3 -shad-cn-Oscar olano.jpg>)

4.- Cuarta evidencia - Layout con footer, navbar y appshell:
![alt text](<Docs/evidencia 4 -oscar olano-layouts.jpg>)
